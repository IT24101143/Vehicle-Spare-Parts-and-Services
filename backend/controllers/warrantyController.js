...
// @desc    Get my warranty claims
// @route   GET /api/warranty/myclaims
...
// @desc    Check warranty status for a product
// @route   GET /api/warranty/check/:orderId/:productId
...
// @desc    Add replacement to history (Admin)
// @route   POST /api/warranty/:id/replacement
...
// @desc    Download warranty invoice PDF
// @route   GET /api/warranty/:id/invoice
...
// @desc    Download warranty card PDF (after approval)
// @route   GET /api/warranty/:id/card
