...
import { FiPackage, FiTruck, FiCheck, FiMapPin, FiCreditCard, FiShield, FiAlertCircle } from 'react-icons/fi';
          ...
          <div className="space-y-6">
            ...
            <div className="bg-dark-800/40 backdrop-blur-xl rounded-2xl border border-dark-700/50 p-6">
              ...
              <div className="space-y-2 text-dark-300">
                ...
                <div className="flex justify-between">
                  <span>Status</span>
                  <span className={`capitalize ${order.paymentStatus === 'completed' ? 'text-green-400' : 'text-yellow-400'}`}>
                    {order.paymentStatus}
                  </span>
                </div>
