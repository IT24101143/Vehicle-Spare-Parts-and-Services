...
import { FiShoppingCart, FiHeart, FiShare2, FiCheck, FiTruck, FiShield, FiStar, FiChevronRight } from 'react-icons/fi';
          ...
          <div>
            ...
            <div className="mb-6">
              {product.stockQuantity > 10 ? (
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-sm text-dark-400 ml-4 font-medium">{product.stockQuantity} units ready for immediate shipping</p>
                </div>
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-sm text-orange-400/80 ml-4 font-bold">Hurry! Only {product.stockQuantity} items remaining</p>
                </div>
              ) : (
                <div className="flex flex-col gap-1">
            ...
            <div className="bg-dark-800/40 backdrop-blur-xl rounded-xl border border-dark-700/50 p-5 mb-6">
              <h3 className="font-semibold text-white mb-3 flex items-center">
                <FiShield className="mr-2 text-primary-400" /> Compatibility
              </h3>
              <div className="grid grid-cols-2 gap-3 text-sm">
                <div><span className="text-dark-400">Vehicle Type:</span> <span className="text-dark-200">{product.vehicleType}</span></div>
                <div><span className="text-dark-400">Brand:</span> <span className="text-dark-200">{product.vehicleBrand}</span></div>
                {product.vehicleModel && <div><span className="text-dark-400">Model:</span> <span className="text-dark-200">{product.vehicleModel}</span></div>}
                <div><span className="text-dark-400">Manufacturer:</span> <span className="text-dark-200">{product.manufacturer}</span></div>
              </div>
            </div>
